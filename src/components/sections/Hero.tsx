...
export default function Hero() {
  return (
    <section id="home" className="relative h-screen flex flex-col items-center justify-center overflow-hidden bg-[#000b3d]">
      
      {/* 1. Base Image - Posisi agak ke atas biar kepala nggak kepotong */}
      <div className="absolute inset-0 bg-[url('/bg-hero.jpg')] bg-cover bg-[center_top_10%] md:bg-[center_top_20%]" />
      
      {/* 2. Blue Filter Overlay */}
      <div className="absolute inset-0 bg-[#000b3d] opacity-75 mix-blend-multiply" />
      
      {/* 3. Grid Pattern Overlay */}
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#ffffff08_1px,transparent_1px),linear-gradient(to_bottom,#ffffff08_1px,transparent_1px)] bg-[size:4rem_4rem]" />

      {/* 4. Bottom Gradient Fade */}
      <div className="absolute bottom-0 left-0 w-full h-56 bg-gradient-to-t from-[#000b3d] via-[#000b3d]/80 to-transparent z-10" />
      ...
      <div className="relative z-20 flex flex-col items-center text-center w-full px-4 max-w-5xl">
        ...
        {/* Sub-headline */}
        <p className="text-gray-300 text-base md:text-lg max-w-2xl mb-10 font-medium leading-relaxed opacity-80">
          <strong className="text-white">Focus Archery Sport Team</strong> — Bergabunglah dengan komunitas pencetak atlet panahan berprestasi tingkat nasional dan internasional.
        </p>

        {/* Action Buttons */}
        <div className="flex flex-col sm:flex-row gap-4 mb-16">
          <a href="#" className="bg-[#2ecc71] hover:bg-[#27ae60] text-white px-7 py-3.5 rounded-xl font-bold flex items-center justify-center gap-2 transition-all hover:scale-105 shadow-lg shadow-green-500/20 text-sm">
        ...
        <div className="grid grid-cols-3 gap-8 md:gap-32 w-full max-w-3xl">
          ...
          <div className="text-center">
            <div className="text-4xl md:text-[3rem] font-black text-[#60a5fa] mb-1">200+</div>
            <div className="text-gray-400 text-[10px] font-bold tracking-[0.15em] uppercase">Member Aktif</div>
          </div>
          <div className="text-center">
            <div className="text-4xl md:text-[3rem] font-black text-[#f97316] mb-1">8+</div>
